...
public class Goomba extends com.brentaureli.mariobros.Sprites.Enemies.Enemy
{
    ...
    float angle;
    public Vector2 direccion, temporal, puntoDestino;
    ...
    public Goomba(PlayScreen screen, float x, float y) {
        ...
        stateTime = 0;
        setBounds(getX(), getY(), 16 / Juego.PPM, 16 / Juego.PPM);
        setToDestroy = false;
        destroyed = false;
        angle = 0;
    ...
    protected void defineEnemy() {
        ...
        fdef.filter.categoryBits = Juego.ENEMY_BIT;
        ...
        fdef.filter.categoryBits = Juego.ENEMY_HEAD_BIT;
        b2body.createFixture(fdef).setUserData(this);
    ...
    public void hitOnHead(Player player) {
        setToDestroy = true;
        Juego.manager.get("audio/sounds/stomp.wav", Sound.class).play();
    }
